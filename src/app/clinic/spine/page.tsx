...
const data: ClinicData = {
  number: '01', slug: 'spine',
  name: '척추·체형클리닉', shortName: '척추·체형클리닉',
  ...
  faqs: [{ q: '[ 질문 1 ]', a: '[ 답변 입력 예정 ]' }, { q: '[ 질문 2 ]', a: '[ 답변 입력 예정 ]' }, { q: '[ 질문 3 ]', a: '[ 답변 입력 예정 ]' }],
}
export default function SpinePage() { return <ClinicPageTemplate data={data} /> }
